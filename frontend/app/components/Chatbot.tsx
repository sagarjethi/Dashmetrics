  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm your Dashmetrics assistant. I can help you analyze meme coins, spot trends, and identify potential rugs. What would you like to know?",
              ...
              <CardContent className="p-0 flex flex-col h-full">
                ...
                <div className="flex items-center justify-between p-3 bg-black/20 backdrop-blur-sm border-b border-white/10">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">Dashmetrics Assistant</span>
                  </div>
                  <Button
                    variant="ghost"
                    size="icon"
